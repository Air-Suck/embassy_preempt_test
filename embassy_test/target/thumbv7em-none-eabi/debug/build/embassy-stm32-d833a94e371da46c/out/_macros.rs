macro_rules ! set_clocks { ($ ($ (# [$ m : meta]) * $ k : ident : $ v : expr ,) *) => { { # [allow (unused)] struct Temp { $ ($ (# [$ m]) * $ k : Option < crate :: time :: Hertz > ,) * } let all = Temp { $ ($ (# [$ m]) * $ k : $ v ,) * } ; crate :: rcc :: set_freqs (crate :: rcc :: Clocks { hclk1 : all . hclk1 , pclk1 : all . pclk1 , pclk1_tim : all . pclk1_tim , pclk2 : all . pclk2 , pclk2_tim : all . pclk2_tim , pll1_q : all . pll1_q , pllsai1_q : all . pllsai1_q , rtc : all . rtc , sys : all . sys , }) ; } } ; }
#[allow(unused)]
